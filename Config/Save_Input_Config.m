...
u.feed.flex.d = 6.35; % 플렉시블 내경 (1/4" 보어 호스)
unit.feed.flex.d = "mm"; % m, mm, cm, in
u.feed.flex.L = 1.0; % 플렉시블 길이
unit.feed.flex.L = "m"; % m, mm, cm, in
u.feed.flex.fmult = 4; % 주름관 마찰 배수 (매끈관=1, 주름관 4~10; 2026 분무+연소시험 교정값, 연소 우선)
...
u.fuel.N = 7;
u.fuel.a = 0.055; % 2026 연소시험 교정값 (연료 소모량 0.170 kg = 적재량 일치; 문헌값 3.461e-2)
u.fuel.n = 0.48;
